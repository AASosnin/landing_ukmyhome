  ...
  elementInfoListTemplate.insertAdjacentHTML('beforeend', `
    <li>
      <div class="element-info-list__li">
        ...
        <div class="element-info-list__li-info element-info-list__li-info-close">
          <p>${el.text}</p>
        </div>
      </div>
    </li>
...
infoListBtnOpen.forEach((btn) => {
  btn.addEventListener("click", (e) => {
    ...
    if (!infoBlock.classList.contains("element-info-list__li-info-close")) {
      infoBlock.classList.toggle("element-info-list__li-info-close");
    }
    else {
      allBlocks.forEach((el) => {
        if (!el.classList.contains(".element-info-list__li-info-close")) {
          el.classList.add("element-info-list__li-info-close");
        }
      })
      const infoBlock = btn.parentElement.parentElement.parentElement.querySelector(".element-info-list__li-info");
      infoBlock.classList.toggle("element-info-list__li-info-close");
